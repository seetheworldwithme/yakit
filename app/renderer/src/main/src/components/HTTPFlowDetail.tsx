              ...
              <Col span={12}>
                <YakitCollapse defaultActiveKey={'request'}>
                  <YakitCollapse.YakitPanel key={'request'} header={'Request Headers'}>
                    <Descriptions
                      className={classNames(styles['http-flow-detail-descriptions'], 'yakit-descriptions')}
                      bordered={true}
                      column={2}
                      size={'small'}
                    >
                        ...
                        title={
                          <div className={styles['table-header-rules']}>
                            <Space>
                              ...
                              <Tooltip title={t('HTTPFlowDetailMini.previousRule')}>
                                <YakitButton
                                  ...
                                  onClick={() => {
                                    httpFlowTableRef.current?.jumpDataProjectHighLight('prev')
                                  }}
                                ></YakitButton>
                              </Tooltip>
                              <Tooltip title={t('HTTPFlowDetailMini.nextRule')}>
                                <YakitButton
                                  ...
                                  onClick={() => {
                                    httpFlowTableRef.current?.jumpDataProjectHighLight('next')
                                  }}
                                ></YakitButton>
                              </Tooltip>
                            </Space>
                            ...
                            <Space>
                              ...
                              <YakitButton type="primary" size="small" onClick={exportMITMRuleExtractedData}>
