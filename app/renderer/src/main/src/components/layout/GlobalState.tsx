...
export const GlobalState: React.FC<GlobalReverseStateProp> = React.memo((props) => {
  ...
  const content = useMemo(() => {
    return (
      <div
        className={styles['global-state-content-wrapper']}
        style={{ width: i18n.language.startsWith('zh') ? 450 : 550 }}
      >
            ...
            <div className={styles['body-info']}>
              ...
              <div className={styles['info-right']}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
                  <YakitButton type="text" className={styles['btn-style']} onClick={handleAutoInstallMITMCertificate}>
                    {t('Home.cert.autoInstallButton')}
                  </YakitButton>
                  <YakitButton type="text" className={styles['btn-style']} onClick={() => showManualInstallGuide()}>
          ...
          {!!Array.from(runNodeList).length && (
            <>
              <div className={styles['body-info']}>
                ...
                <div className={styles['info-right']}>
                  <YakitButton type="text" colors="danger" className={styles['btn-style']} onClick={onCloseAllRunNode}>
                    {t('YakitButton.closeAll')}
                  </YakitButton>
                </div>
              </div>
          ...
          <div className={styles['body-wrapper']}>
            ...
            {ruleUpdate?.NeedUpdate && (
              <div className={styles['body-info']}>
                ...
                <div className={styles['info-right']}>
                  <YakitButton type="text" className={styles['btn-style']} onClick={downloadRuleUpdate}>
                    {ruleUpdate.State === 'empty' ? t('YakitButton.resetAll') : t('YakitButton.oneClickUpdate')}
                  </YakitButton>
                </div>
              </div>
            )}
  ...
  return (
    <>
      ...
      <YakitHint
        ...
        content={ruleUpdate?.State === 'empty' ? t('GlobalState.resetRulesHint') : t('GlobalState.updateRulesHint')}
        onOk={() => {
