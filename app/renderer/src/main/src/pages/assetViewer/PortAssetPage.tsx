      ...
      <div className={styles['portAsset']}>
        <div className={styles['portAsset-head']}>
          ...
          <div className={styles['head-extra']}>
            ...
            >
              <Badge dot={offsetDataInTop.length > 0} offset={[-5, 4]} className={styles['port-table-badge']}>
        ...
        <PortTable
          ...
          tableTitleExtraOperate={
            <>
              <YakitPopconfirm
                title={
                  selectNumber > 0 ? t('PortAssetTable.confirmDeleteSelected') : t('PortAssetTable.confirmClearList')
                }
                onConfirm={() => {
                  onRemove()
                }}
  ...
  return (
    <>
      <Descriptions
        ...
        title={t('PortAssetDescription.detailTitle')}
      >
