                ...
                extra={
                  <>
                    <YakitButton
                      type="text"
                      colors="danger"
                      onClick={(e) => handleVariableReset(e, 'methodGet', { Key: '', Value: '' }, methodGetRef)}
                      size="small"
                    >
                      {t('YakitButton.reset')}
                    </YakitButton>
                ...
                extra={
                  <>
                    <YakitButton
                      type="text"
                      colors="danger"
                      onClick={(e) => handleVariableReset(e, 'methodPost', { Key: '', Value: '' }, methodPostRef)}
                      size="small"
                    >
                      {t('YakitButton.reset')}
                    </YakitButton>
              ...
              <YakitPanel
                ...
                extra={
                  <>
                    ...
                    <YakitButton
                      type="text"
                      onClick={(e) => handleVariableAdd(e, 'cookie', 'Cookie', { Key: '', Value: '' }, cookieRef)}
                      className={styles['btn-padding-right-0']}
                      size="small"
                    >
                      {t('YakitButton.add')}
              ...
              <YakitPanel
                ...
                extra={
                  <>
                    ...
                    <YakitButton
                      type="text"
                      onClick={(e) => handleVariableAdd(e, 'headers', 'Header', { Key: '', Value: '' }, headersRef)}
                      className={styles['btn-padding-right-0']}
                      size="small"
                    >
                      {t('YakitButton.add')}
                      ...
                      <div className={styles['matchersList-item']} key={`ID:${subIndex}`}>
                        <div className={styles['matchersList-item-heard']}>
                          ...
                          <span className={styles['item-label']}>
                            [{matcherTypeList(t).find((e) => e.value === subItem.MatcherType)?.label}]
                          </span>
                          <span className={styles['item-number']}>{subItem.Group?.length}</span>
                        </div>
                        <MatchersAndExtractorsListItemOperate
                          onRemove={() => onRemove(index, subIndex)}
                          onEdit={() => onEdit(index, subIndex)}
                          popoverContent={
                            <MatcherItem matcherItem={subItem} onEdit={() => {}} notEditable={true} httpResponse="" />
                          }
                        />
                      </div>
                    </React.Fragment>
