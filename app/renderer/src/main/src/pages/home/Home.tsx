        ...
        ipcRenderer
          ...
          .then((p: string) => {
            if (p) {
              ...
              yakitNotify('error', t('YakitNotification.generationFailedNoError'))
            }
          })
          .catch(() => {})
        m.destroy()
                  ...
                  >
                    <div className={styles['home-card-header']}>
                      <div className={styles['home-card-header-title']}>
                        ...
                        <span className={styles['title-text']}>{t('YakitRoute.MITM Interactive Hijacking')}</span>
                        <YakitButton
                          type="outline1"
                          style={{ marginLeft: 8 }}
                          onClick={(e) => {
                      ...
                      <div className={styles['home-card-header-desc']}>{t('YakitRoute.mitmSslHijack')}</div>
                    </div>
                    {showMITMCertWarn && (
                      <div className={styles['home-card-config-detection']}>
                        <div className={styles['config-detection-left']}>
                        ...
                        <div className={styles['mitm-operation']}>
                          ...
                          >
                            ...
                            >
                              ...
                              >
                                <div className={styles['operation-btn-wrapper']} ref={mitmDropdownRef}>
                                  <div
                                    className={styles['operation-btn-left']}
              ...
              {isScanMode ? (
                ...
                <>
                  <div ref={signlejumpRef} className={styles['signle-jump-wrapper']}>
                    ...
                    >
                      <div className={styles['signle-jump-item-cont']}>
                        ...
                        <div className={styles['signle-jump-item-cont-right']}>
                          <div className={styles['single-jump-cont-title']}>{t('YakitRoute.Yso-Java Hack')}</div>
                    ...
                    <div className={styles['signle-jump-item']} onClick={() => onMenu({ route: YakitRoute.DNSLog })}>
                      <div className={styles['signle-jump-item-cont']}>
                        <PublicDNSLogIcon className={styles['signle-jump-item-icon']} />
                        <div className={styles['signle-jump-item-cont-right']}>
                          <div className={styles['single-jump-cont-title']}>{t('YakitRoute.DNSLog')}</div>
                          <div className={styles['single-jump-cont-desc']}>{t('YakitRoute.subdomainAutoGenerate')}</div>
                        </div>
                      </div>
                    </div>
                    <div className={styles['signle-jump-item']} onClick={() => onMenu({ route: YakitRoute.Codec })}>
                      <div className={styles['signle-jump-item-cont']}>
                        <PublicCodecIcon className={styles['signle-jump-item-icon']} />
                        <div className={styles['signle-jump-item-cont-right']}>
                          <div className={styles['single-jump-cont-title']}>{t('YakitRoute.Codec')}</div>
                          <div className={styles['single-jump-cont-desc']}>{t('Home.codecPluginCustom')}</div>
                        </div>
                      </div>
                    </div>
                  </div>
                ...
                {renderToolsList.length ? (
                  <>
                    {renderToolsList.map((item) => (
                      <div className={styles['tools-list-item']} key={item.label} onClick={item.onClick}>
            ...
            <div className={styles['data-preview-wrapper']}>
              ...
              <div className={styles['data-preview-item']}>
                ...
                <div className={styles['data-preview-item-cont']}>
                  {!judgeMoreTenGB ? (
                    <span className={styles['data-preview-item-size']}>{curProjectInfo?.FileSize}</span>
                  ) : (
                    <>
                      <span className={styles['data-preview-item-size']} style={{ color: '#f6544a' }}>
                        {curProjectInfo?.FileSize}
                      </span>
              ...
              <div className={styles['data-preview-item']}>
                ...
                <div
                  ...
                  onClick={() => onMenu({ route: YakitRoute.DB_HTTPHistory })}
                >
                  <span className={styles['data-preview-item-number']}>{numeral(historyData).format('0,0')}</span>
                </div>
              </div>
              {(riskLevelTotal('严重') || riskLevelTotal('高危') || riskLevelTotal('中危') || riskLevelTotal('低危')) >
              0 ? (
              ...
              <div className={styles['data-preview-item']}>
                ...
                {visibleOnline && (
                  <YakitGetOnlinePlugin
                    ...
                    getContainer={document.getElementById(`main-operator-page-body-${YakitRoute.NewHome}`) || undefined}
                  />
                )}
              </div>
            </div>
