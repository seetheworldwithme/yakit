...
export const HoleCollectPage: React.FC<HoleCollectPageProps> = (props) => {
  const { t } = useI18nNamespaces(['admin', 'yakitUi', 'yakitRoute'])
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, i: API.RiskLists) => <YakitTag>{i.created_at > 0 ? formatTimestamp(i.created_at) : '-'}</YakitTag>,
    },
    {
          ...
          return (
            <div>
              <div className={styles['table-title']}>
                ...
                <Space>
                  <ExportExcel getData={getData} fileName={t('HoleCollectPage.riskAndVulnerability')} />
                  <YakitPopconfirm
                    title={
              ...
              <div className={styles['filter-box']}>
                <Form onFinish={onFinish} form={form} layout="inline" className={styles['filter-box-form']}>
                  <Form.Item name="search" label={t('HoleCollectPage.vulnerabilityTitle')}>
                    <YakitInput placeholder={t('HoleCollectPage.inputVulnerabilityTitle')} allowClear />
                  </Form.Item>
                  ...
                  <Form.Item name="net_work" label={'ip'}>
                    <YakitInput placeholder={t('HoleCollectPage.inputIp')} allowClear style={{ width: 180 }} />
                  </Form.Item>
