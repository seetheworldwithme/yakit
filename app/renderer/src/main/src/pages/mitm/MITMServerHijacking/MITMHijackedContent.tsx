  ...
  const getMITMFilter = useMemoizedFn(() => {
    grpcMITMGetFilter()
      .then((res: MITMFilterSchema) => {
        ...
        const flag = includeHostnameFlag || includeUriFlag || includeSuffixFlag || getAdvancedFlag(data.advancedFilters)
          ...
          {mitmVersion === MITMVersion.V2 ? (
            <div className={styles['mitm-v2-hijacked-manual-heard-extra']}>
              <div className={styles['mitm-v2-hijacked-manual-heard-extra-left']}>
                <TableTotalAndSelectNumber total={manualTableTotal} selectNum={manualTableSelectNumber} />
              </div>
