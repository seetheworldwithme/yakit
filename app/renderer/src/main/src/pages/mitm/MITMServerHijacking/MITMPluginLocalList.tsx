          ...
          {selectGroup.map((i) => {
            return (
              ...
              >
                ...
                <span className={classNames(style['mitm-plugin-query-plugin-group-name'], 'content-ellipsis')}>
                  {i.name}
                </span>
              </YakitTag>
            )
        ...
        renderOpt: (info: TagValue) => {
          return (
            <div className={classNames(style['mitm-plugin-local-tag-select-item'])}>
              <span className={classNames(style['tag-select-item-name'], 'content-ellipsis')}>{info.Name}</span>
    ...
    <div className={style['plugin-group-list']}>
      ...
      <DelGroupConfirmPop
        ...
        onOk={() => {
          ...
          onDelGroup(delGroup, () => {
            setDelGroup(undefined)
            setRemoteValue(RemoteGV.PluginGroupDelNoPrompt, delGroupConfirmPopRef.current.delGroupConfirmNoPrompt + '')
            setDelGroupConfirmPopVisible(false)
          })
        }}
      ></DelGroupConfirmPop>
