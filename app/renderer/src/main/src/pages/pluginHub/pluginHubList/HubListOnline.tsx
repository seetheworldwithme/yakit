...
export const HubListOnline: React.FC<HubListOnlineProps> = memo((props) => {
  ...
  const { t, i18n } = useI18nNamespaces(['plugin', 'pluginHub', 'yakitUi'])
  ...
  const { data: tabTotal = { online: 0, official: 0, local: 0 }, run: runTabTotal } = useRequest(async () => {
          ...
          <div className={styles['outer-list']}>
            <div className={styles['list-body']}>
              <HubOuterList
                ...
                listTabs={[
                  {
                    tab: `${t('PluginTabName.allPlugin')}（${getTotalLoading ? '...' : tabTotal.online}）`,
                    key: 'all',
                  },
                  {
                  ...
                  {
                    tab: `${t('PluginTabName.localPlugin')}（${getTotalLoading ? '...' : tabTotal.local}）`,
                    key: 'local',
                  },
                ]}
                ...
                {listLength > 0 ? (
                  ...
                  <div className={styles['hub-list-empty']}>
                    <YakitEmpty
                      ...
                      description={isCommunityEdition() || !showUpload ? '' : t('HubListOnline.bulkUploadHint')}
                    />
            ...
            <HubDetailList
              ...
              filterNode={
                <PluginGroup
                  ...
                  setSelectGroup={(group) => onDetailFilter(convertGroupParam({ ...getFilters() }, { group }))}
