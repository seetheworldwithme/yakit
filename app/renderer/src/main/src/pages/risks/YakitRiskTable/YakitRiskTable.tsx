        ...
        {showType === 'detail' && (
          <div className={classNames(styles['content-resize-second'], detailClassName)} ref={descriptionsRef}>
            <Descriptions bordered size="small" column={column} labelStyle={{ width: 120 }}>
              ...
              <Descriptions.Item label={t('YakitRiskDetails.reverse_token')} contentStyle={{ minWidth: 120 }}>
                {info?.ReverseToken || '-'}
              </Descriptions.Item>
              ...
              <Descriptions.Item label={t('YakitRiskDetails.verification_status')}>
                <YakitTag color={`${!info.WaitingVerified ? 'success' : 'info'}`}>
                  {!info.WaitingVerified ? t('YakitRiskDetails.verified') : t('YakitRiskDetails.not_verified')}
                </YakitTag>
              </Descriptions.Item>
      ...
      firstNode={
        <div className={styles['content-resize-collapse']}>
          ...
          <YakitSpin spinning={loading}>
            <AuditResultCollapse data={yakURLData} jumpCodeScanPage={jumpCodeScanPage} isShowExtra={isShowExtra} />
          </YakitSpin>
        </div>
      }
