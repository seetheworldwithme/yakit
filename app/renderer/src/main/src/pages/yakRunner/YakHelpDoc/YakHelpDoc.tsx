...
import type { DataProps, YakHelpDocItemLoadProps, YakHelpDocProps } from './YakHelpDocType'
  ...
  return (
    <div className={styles['yak-help-doc-item-load']}>
      {loading ? (
        ...
        <>
          {data.length > 0 ? (
            <CollapseList type="sideBar" onlyKey="key" list={data} titleRender={titleRender} renderItem={renderItem} />
          ) : (
