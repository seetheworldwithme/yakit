  ...
  return (
    <div className={styles['yak-runner-welcome-page']} ref={ref}>
      <div className={styles['title']}>
        ...
        <div className={styles['header-style']}>欢迎智能化代码安全检测与验证系统静态分析工作台</div>
      </div>
      <div
      ...
      >
        <div className={styles['operate']}>
          ...
          <div className={styles['operate-btn-group']}>
            <div className={classNames(styles['btn-style'], styles['btn-open-compile'])} onClick={openCompileProject}>
