...
const YakEditorDefaultShortcut: MonacoShortcutKeyEventInfo[] = [
  // 基础编辑
  {
    name: 'ShortcutKey.undo',
    keys: [YakitKeyMod.CtrlCmd, YakitKeyBoard.KEY_Z],
  },
  {
    name: 'ShortcutKey.redo',
...
const YakEditorShortcutKeyEvents: EventsType = {
  'sendAndJump*common': {
    name: 'ShortcutKey.sendAndJump',
    keys: [YakitKeyMod.CtrlCmd, YakitKeyBoard.KEY_R],
  },
  'send*common': {
    name: 'ShortcutKey.sendOnly',
