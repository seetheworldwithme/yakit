...
const OutlineRobot = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="12" cy="4" r="1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <circle cx="9" cy="14" r="1" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <circle
      cx="15"
      cy="14"
      r="1"
...
const OutlineLink2 = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask id="mask0_1_3058" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
      <rect width="24" height="24" fill="#D9D9D9" />
    </mask>
...
const OutlineLinkout = () => (
  <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    <mask id="mask0_1_3057" style={{ maskType: 'alpha' }} maskUnits="userSpaceOnUse" x="0" y="0" width="24" height="24">
      <rect width="24" height="24" fill="#D9D9D9" />
    </mask>
...
const OutlineClose = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <path d="M16 15L13 12L16 9" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
/**
...
const listTwoIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    ...
    <path
      ...
      strokeLinejoin="round"
    />
    <path d="M14 4H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14 9H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14 15H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
    <path d="M14 20H21" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
  </svg>
)
/**
...
const OutlineMicroscope = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
    <path
      d="M6.66667 17.4H13.7778M4 21H20M13.7778 21C15.428 21 17.0107 20.3363 18.1776 19.1548C19.3444 17.9733 20 16.3709 20 14.7C20 13.0291 19.3444 11.4267 18.1776 10.2452C17.0107 9.06375 15.428 8.4 13.7778 8.4H12.8889M9.33333 13.8H11.1111M12 6.6V3.9C12 3.66131 11.9063 3.43239 11.7397 3.2636C11.573 3.09482 11.3469 3 11.1111 3H9.33333C9.09759 3 8.87149 3.09482 8.70479 3.2636C8.5381 3.43239 8.44444 3.66131 8.44444 3.9V6.6M9.33333 12C8.86184 12 8.40965 11.8104 8.07625 11.4728C7.74286 11.1352 7.55556 10.6774 7.55556 10.2V6.6H12.8889V10.2C12.8889 10.6774 12.7016 11.1352 12.3682 11.4728C12.0348 11.8104 11.5826 12 11.1111 12H9.33333Z"
      stroke="currentColor"
      strokeWidth="1.5"
      strokeLinecap="round"
      strokeLinejoin="round"
...
/*
 * @description Outline/CheckCheck
 */
