  ...
  const onYakRunnerScanHistoryPageInfo = useMemoizedFn((info) => {
    try {
      const data = JSONParseLog(info, {
        page: 'yakRunnerScanHistory',
        fun: 'onYakRunnerScanHistoryPageInfo',
      }) as unknown as YakRunnerScanHistoryPageInfoProps
      if (!data) return
            ...
            <div className={styles['risk-tag-wrapper']}>
              {renderRisk([
                ...
                },
                {
                  ...
                  text: t('YakitTag.warning'),
                },
                {
                  risk: 'high',
                  count: +record.HighCount,
                  text: t('YakitTag.high'),
                },
                {
                  risk: 'critical',
                  count: +record.CriticalCount,
                  text: t('YakitTag.critical'),
                },
              ])}
            </div>
          )
      ...
      <div className={styles['compile-history-header']}>
        ...
        <div className={styles['compile-history-sub-title']}>
          <div className={styles['modal-sub-title']}>
            <YakitPopconfirm
              title={
                checkedList.length > 0 ? t('YakitCheckbox.confirmDeleteSelected') : t('YakitCheckbox.confirmClearList')
              }
              onConfirm={() => {
                onRemoveMultiple()
              }}
            ...
            >
              <YakitButton
                ...
                colors="danger"
              >
                {checkedList.length > 0 ? t('YakitButton.delete') : t('YakitButton.clear')}
              </YakitButton>
            </YakitPopconfirm>
          </div>
        </div>
